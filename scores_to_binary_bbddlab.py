...
def main():
    ...
    for file_name in glob.glob(os.path.join(in_path, '*_allscores_patchhop_1.csv')):
        ...
        bin_df.to_csv(path_or_buf=out_path + file_name + '_binary_logscores_th0027.csv', index=False)
        print('Saved\n-----\n')
    ...
    print('Median:\n' + str(np.mean(median_array)))  # 0.001179373284057722
    print('\nMean:\n' + str(np.mean(mean_array)))  # 0.0026679743814952746
    print('\nPercentile 75:\n' + str(np.mean(percentile_array)))  # 0.002307613669274959
